...
var UserManage = { 
	...
	editUser:function(){try {
		//$.messager.alert("操作提示","编辑用户","info");
		m_userInfo_dlg = art.dialog({
			id : 'dlgAddUser',
			title : '编辑用户',
			content : "<iframe scrolling='yes' frameborder='0' src='view/user/userBill.jsp?type=1?userId=5' style='width:600px;height:470px;overflow:hidden'/>",
			lock : true,
			initFn : function() {
			}
		});
