...
<meta http-equiv="description" content="This is my page"> 
  ...
  <body>
   <div id="div_userInfo" style="text-align:left;overflow:hidden;">
		 ...
		 <p name="p_pwd"><label>登录密码：</label><input id="txtUserPwd" type="password" class="easyui-validatebox"  style="width:324px" /></p>
		 <p name="p_pwd"><label>登录密码：</label><input id="txtUserPwdAgain" type="password" class="easyui-validatebox"  style="width:324px" /></p>
		 ...
		 <p><label>机构名称：</label><input id="txtUserOrgName" type="text" class="easyui-combotree" style="width:324px"/></p>
