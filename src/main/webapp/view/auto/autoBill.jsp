...
<meta http-equiv="description" content="This is my page"> 
  ...
  <body>
	...
	<div id="div_autoInfo" style="text-align:left;overflow:hidden;">
		 ...
		 <p><label>车主电话：</label><input id="txtUserMobile" style="width:210px"  class="easyui-validatebox"   readonly="readonly"/></p>
		 ...
		 <p><label>注册时间：</label><input id="txtRegisterTime" style="width:210px"  class="easyui-validatebox"  readonly="readonly"/></p>
	 </div>
